<template>
    <div>
        ...
        <p>
            ...
            <code>size</code>为
            <code>large</code>或
            <code>small</code>将按钮样式设置为大/小尺寸，不设置为默认尺寸。
        </p>
        <DocMarkdown
            :code="code.size"
        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>true-value</td>
                        <td>当前选择的值，当使用类似 1 和 0 来判断是否选中时会很有用，需要配合 value 去完成</td>
                        <td>String, Number, Boolean</td>
                        <td>true</td>
                    </tr>
                    <tr>
                        <td>false-value</td>
                        <td>没有选中时的值，当使用类似 1 和 0 来判断是否选中时会很有用，需要配合 value 去完成</td>
                        <td>String, Number, Boolean</td>
                        <td>true</td>
                    </tr>
                    <tr>
        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    <tr>
                        <td>on-change</td>
                        <td>只在单独使用时有效, 在选项状态发生改变时触发，返回当前状态。</td>
                        <td>value</td>
                    </tr>
                </tbody>
            </table>
